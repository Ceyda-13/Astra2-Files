...
class MiniGameAttendance(ui.ScriptWindow):
	...
	def __LoadWindow(self):
		...
		net.SendMiniGameAttendanceRequestRewardList()
		net.SendMiniGameAttendanceRequestData(player.ATTENDANCE_DATA_TYPE_DAY)
		net.SendMiniGameAttendanceRequestData(player.ATTENDANCE_DATA_TYPE_MISSION_CLEAR)
		net.SendMiniGameAttendanceRequestData(player.ATTENDANCE_DATA_TYPE_GET_REWARD)
		net.SendMiniGameAttendanceRequestData(player.ATTENDANCE_DATA_TYPE_SHOW_MAX)
			...
			if self.number_button[number].IsIn():
				if selfs.wndToolTipItem:
					if self.reward_dict.has_key(number):
						...
						selfs.wndToolTipItem.SetAttendanceRewardItem(item_vnum)
	...
	def MiniGameAttendanceRequestRewardList(self):
		self.reward_dict = player.GetAttendanceRewardList()
	...
	def __RewardAccept(self):
		net.SendMiniGameAttendanceButtonClick(self.cur_attendance_number)
		self.__RewardCancel()
