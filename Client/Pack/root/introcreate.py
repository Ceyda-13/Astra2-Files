...
class CreateCharacterWindow(ui.Window):
	...
	if ENABLE_WOLFMAN_CHARACTER:
		M2STATPOINT += [(6, 2, 2, 6)] ## WOLFMAN ##
		M2JOBLIST[4] = localeInfo.JOB_WOLFMAN
		LEN_JOBLIST += 1
		M2_CONST_ID += [(playerSettingModule.RACE_WOLFMAN_M, -1)]
	...
	def SelectJob(self, job_id):		
		...
		if ENABLE_WOLFMAN_CHARACTER and self.M2_CONST_ID[self.job_id][MAN] == playerSettingModule.RACE_WOLFMAN_M	:
