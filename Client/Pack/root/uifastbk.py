...
class FastBK(ui.ScriptWindow):
	...
	def __Load(self):
		self.__Load_LoadScript("uiscript/fastbk.py")
	...
	def butonlar(self, func):
		...
		if func == 1:
			net.SendChatPacket("/fastbk 1 " + str(skillIndexx))
		elif func == 2:
			net.SendChatPacket("/fastbk 0 " + str(skillIndexx))
	...
	def yenile(self):
		self.bkslot.SetItemSlot(0, 50300, player.GetItemCountByVnum(50300))
