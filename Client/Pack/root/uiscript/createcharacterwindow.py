...
#thinboard_WIDTH = 198#194
thinboard_HEIGHT = 364#359

thinboard_LEFT_WIDTH = 175

#SELECT_Y = BOARD_Y + 312 + 7

thinboard_RIGHT_WIDTH = 180
thinboard_RIGHT_HEIGHT = 270
###################
...
window = {
	...
	[
		...
		##Character Board(Left)##
		{
			...
			"x" : BOARD_X, "y" : BOARD_Y, "width" : thinboard_LEFT_WIDTH + (X_GAP * 2) + 1, "height" : 305,
			
			"children" :
			[
				## Empire Flag & Name##
				{	
					"name" : "EmpireNameSlot", "type" : "thinboard",
					"x" : X_GAP, "y" : Y_GAP, "width" : thinboard_LEFT_WIDTH, "height" : 42,
				...
				{
					"name" : "SelectJobSlot", "type" : "thinboard",
					"x" : X_GAP, "y" : 61, "width" : thinboard_LEFT_WIDTH, "height" : 231,
					"children" :
					[
						##Job Select##
						{
		...
		## Select Sex & Shape ##
		{
			"name" : "select_thinboard2", "type" : "thinboard", 
			"x" : BOARD_X, "y" : BOARD_Y + 305 + 3, "width" : thinboard_LEFT_WIDTH + (X_GAP * 2) + 1, "height" : (Y_GAP * 2) + 48,
			"children" : 
			[
				{
				...
				},
				{
					...
					"x" : thinboard_LEFT_WIDTH + X_GAP - 87, "y" : Y_GAP, "image" : ROOT_PATH + "public_intro_btn/88x47_btn.sub",
					"children" : 
					[
						{
		...
		{
			"name" : "character_discriptionboard", "type" : "thinboard",
			"x" : SCREEN_WIDTH - BOARD_X - (thinboard_RIGHT_WIDTH + (X_GAP * 2)), "y" : BOARD_Y, "width" : thinboard_RIGHT_WIDTH + (X_GAP * 2) + 1, "height" : thinboard_HEIGHT,
			...
			[
				...
				{
					"name" : "text_board", "type" : "thinboard",
					"x" : X_GAP, "y" : Y_GAP, "width" : thinboard_RIGHT_WIDTH, "height" : thinboard_RIGHT_HEIGHT,
...
if localeInfo.IsARABIC():
	window["children"][1]["y"] = BOARD_Y - NAME_Y - 35
	window["children"][10]["children"][0]["children"][1]["y"] = 1
	window["children"][11]["x"] = SCREEN_WIDTH/2 - 111
	window["children"][11]["children"][0]["x"] = 30
	window["children"][11]["children"][0]["y"] = 2
	window["children"][11]["children"][1]["x"] = 55
	window["children"][11]["children"][2]["x"] = 100 - 42
...
if ENABLE_WOLFMAN_CHARACTER:
	...
	window["children"][7]["children"][1]["children"] += [
		{
