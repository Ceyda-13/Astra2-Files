...
if ENABLE_DOG_MODE:
	...
	window["children"][0]["children"] += [

					{
						...
						"text" : uiScriptLocale.OPTION_DOG_INFO,
					},
					{
						"name" : "dog_mode_open",
						"type" : "radio_button",
						...
						"text" : uiScriptLocale.OPTION_DOG_OPEN,
					...
					},
					{
						...
						"text" : uiScriptLocale.OPTION_DOG_CLOSE,
...
if ENABLE_BLOCK_EQUIPMENT: # @@@correction042
	...
	window["height"] += 25
	window["children"][0]["height"] += 25
	for i in xrange(len(window["children"][0]["children"]) - 19):
		window["children"][0]["children"][i+19]["y"] += 25
