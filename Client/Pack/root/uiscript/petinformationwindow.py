			...
			[
				## Page Area
				{
					...
					[
						...
						## Pet Type
						{ 
							"name" : "TypeWindow", "type" : "window", "x" : 65, "y" : 98, "width" : LONG_LABEL_WIDTH, "height" : LONG_LABEL_HEIGHT, "style" : ("attach",),
							"children" :
							(
								{"name":"PetType", "type":"text", "x":0, "y":0, "text": "Super Baby White Dragon", "r":0.83, "g":0.77, "b":0.73, "a":1.0, "all_align" : "center"},
							),	
						},
						...
						## Pet Skill Slot 1
						{
							...
							"slot" : ({"index":1, "x":0, "y":0, "width":32, "height":32},),
						},
						...
						## Pet Skill Slot 2
						{
							...
							"slot" : ({"index":2, "x":0, "y":0, "width":32, "height":32},),
						},
...
window["children"] = window["children"] + [						
	{
		...
		[
			...
			{ 
				...
				"children" :
				(
					{"name":"PetDetermineInfoText1", "type":"text", "x":0, "y":-25, "text": " ", "color":WHITE_COLOR, "all_align" : "center"},
					{"name":"PetDetermineInfoText2", "type":"text", "x":0, "y":-10, "text": " ", "color":WHITE_COLOR, "all_align" : "center"},
					{"name":"PetDetermineInfoText3", "type":"text", "x":0, "y":5, "text": " ", "color":WHITE_COLOR, "all_align" : "center"},
					{"name":"PetDetermineInfoText4", "type":"text", "x":0, "y":20, "text": " ", "color":WHITE_COLOR, "all_align" : "center"},
				),	
			},
