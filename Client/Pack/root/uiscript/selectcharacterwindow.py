...
window = {
	...
	[
		...
		##SelectCharList Board##
		{
			...
			"x" : BOARD_X, "y" : BOARD_Y, "width" : thinboard_LEFT_WIDTH + (X_GAP * 2) + 1, "height" : 305,#331,
			...
			[
				...
				## Select Character Button ##
				{
					...
					"x" : X_GAP, "y" : 61, "width" : thinboard_LEFT_WIDTH, "height" : 231,#253,
					"children" :
					[
		...
		## Create & Delete Button ##
		{
			...
			"x" : BOARD_X, "y" : BOARD_Y + 305 + 3, "width" : thinboard_LEFT_WIDTH + (X_GAP * 2) + 1, "height" : (Y_GAP * 2) + 27,
			"children" : 
			[
				{
				...
				},
				{
					...
					"x" : thinboard_LEFT_WIDTH + X_GAP - 58, "y" : Y_GAP,
		...
		##Description Board(Right)##
		{
			...
			[
				{ 
					...
					"children" :
					[
						{ "name" : "DiscFace", "type" : "image", "x" : DESC_FACE_X, "y" : DESC_FACE_Y, "image" : "icon/face/warrior_m.tga"},
