...
class FastRuh(ui.ScriptWindow):
	...
	def __Load(self):
		self.__Load_LoadScript("uiscript/fastruh.py")
	...
	def butonlar(self, func):
		...
		if func == 1:
			net.SendChatPacket("/fastruh 1 " + str(skillIndexx))
		elif func == 2:
			net.SendChatPacket("/fastruh 0 " + str(skillIndexx))
		return
