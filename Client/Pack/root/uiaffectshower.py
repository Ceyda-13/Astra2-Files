...
class AffectShower(ui.Window):
	...
	if ENABLE_GROWTH_PET_SYSTEM:
		AFFECT_PET_DATA_DICT ={
			...
			5419 : (localeInfo.PET_AFFECT_MONSTER, "d:/ymir work/ui/skill/pet/new_monster.sub"),
			5420 : (localeInfo.PET_AFFECT_STONE, "d:/ymir work/ui/skill/pet/new_stone.sub")
		}
	...
	AFFECT_DATA_DICT =	{
			...
			chr.AFFECT_ATT_SPEED_POTION : (localeInfo.SKILL_INC_ATKSPD, "icon/item/new/yesilpot.png"),
			chr.AFFECT_MOV_SPEED_POTION : (localeInfo.SKILL_INC_MOVSPD, "icon/item/new/morpot.png"),
			...
			# 자동물약 hp, sp
			chr.NEW_AFFECT_AUTO_HP_RECOVERY : (localeInfo.TOOLTIP_AUTO_POTION_REST, "icon/item/dew/72730.tga"),			
			chr.NEW_AFFECT_AUTO_SP_RECOVERY : (localeInfo.TOOLTIP_AUTO_POTION_REST, "icon/item/dew/72726.tga"),

			MALL_DESC_IDX_START+player.POINT_ATT_BONUS : (localeInfo.TOOLTIP_MALL_ATTBONUS_STATIC, "icon/item/new/71028.tga",),
			MALL_DESC_IDX_START+player.POINT_MALL_DEFBONUS : (localeInfo.TOOLTIP_MALL_DEFBONUS_STATIC, "icon/item/new/71030.tga",),
			MALL_DESC_IDX_START+player.POINT_MALL_EXPBONUS : (localeInfo.TOOLTIP_MALL_EXPBONUS, "icon/item/dew/exp.tga",),
			MALL_DESC_IDX_START+player.POINT_MALL_ITEMBONUS : (localeInfo.TOOLTIP_MALL_ITEMBONUS, "icon/item/dew/item.tga",),
			MALL_DESC_IDX_START+player.POINT_MALL_GOLDBONUS : (localeInfo.TOOLTIP_MALL_GOLDBONUS, "icon/item/dew/yang.tga",),
			MALL_DESC_IDX_START+player.POINT_CRITICAL_PCT : (localeInfo.TOOLTIP_APPLY_CRITICAL_PCT,"icon/item/new/kritik.png"),
			MALL_DESC_IDX_START+player.POINT_PENETRATE_PCT : (localeInfo.TOOLTIP_APPLY_PENETRATE_PCT, "icon/item/new/delici.png"),
			MALL_DESC_IDX_START+player.POINT_MAX_HP_PCT : (localeInfo.TOOLTIP_MAX_HP_PCT, "icon/item/new/71027.tga"),
			MALL_DESC_IDX_START+player.POINT_MAX_SP_PCT : (localeInfo.TOOLTIP_MAX_SP_PCT, "icon/item/new/71029.tga"),
			...
			BLEND_DESC_IDX_START+player.POINT_CRITICAL_PCT : (localeInfo.TOOLTIP_AFFECT_POTION_1, "icon/item/new/50821.tga",),
			BLEND_DESC_IDX_START+player.POINT_PENETRATE_PCT : (localeInfo.TOOLTIP_AFFECT_POTION_2, "icon/item/new/50822.tga",),
			BLEND_DESC_IDX_START+player.ATT_SPEED : (localeInfo.TOOLTIP_AFFECT_POTION_3, "icon/item/new/50823.tga",),
			BLEND_DESC_IDX_START+player.POINT_RESIST_MAGIC : (localeInfo.TOOLTIP_AFFECT_POTION_4, "icon/item/new/50824.tga",),
			BLEND_DESC_IDX_START+player.ATT_BONUS : (localeInfo.TOOLTIP_AFFECT_POTION_5, "icon/item/new/50825.tga",),
			BLEND_DESC_IDX_START+player.DEF_BONUS : (localeInfo.TOOLTIP_AFFECT_POTION_6, "icon/item/new/50826.tga",),
			BLEND_DESC_IDX_START+player.POINT_NORMAL_HIT_DAMAGE_BONUS : (localeInfo.TOOLTIP_AFFECT_POTION_7, "icon/item/new/50827.tga",),
			BLEND_DESC_IDX_START+player.POINT_ATTBONUS_MONSTER : (localeInfo.TOOLTIP_AFFECT_POTION_8, "icon/item/new/50828.tga",),
			BLEND_DESC_IDX_START+player.POINT_ATTBONUS_UNDEAD : (localeInfo.TOOLTIP_AFFECT_POTION_9, "icon/item/new/50829.tga",),
			BLEND_DESC_IDX_START+player.POINT_ATTBONUS_DEVIL : (localeInfo.TOOLTIP_AFFECT_POTION_10, "icon/item/new/50830.tga",),
			BLEND_DESC_IDX_START+player.POINT_ATTBONUS_HUMAN : (localeInfo.TOOLTIP_AFFECT_POTION_11, "icon/item/new/50831.tga",),
			BLEND_DESC_IDX_START+player.POINT_ATTBONUS_STONE : (localeInfo.TOOLTIP_AFFECT_POTION_12, "icon/item/new/50832.tga",),
			BLEND_DESC_IDX_START+player.POINT_ATTBONUS_BOSS : (localeInfo.TOOLTIP_AFFECT_POTION_13, "icon/item/new/50833.tga",),
			BLEND_DESC_IDX_START+player.ENERGY : (localeInfo.TOOLTIP_AFFECT_POTION_1, "icon/item/51002.tga",),
	}
	...
	if ENABLE_WOLFMAN_CHARACTER:
		...
		AFFECT_DATA_DICT[chr.AFFECT_RED_POSSESSION] = (localeInfo.SKILL_GWIGEOM, "d:/ymir work/ui/skill/wolfman/red_possession" + END_STRING + ".sub")
		AFFECT_DATA_DICT[chr.AFFECT_BLUE_POSSESSION] = (localeInfo.SKILL_CHEONGEUN, "d:/ymir work/ui/skill/wolfman/blue_possession" + END_STRING + ".sub")
	...
	def BINARY_NEW_AddAffect(self, type, pointIdx, value, duration):
		...
		# TraceError("BINARY_NEW_AddAffect %d %d %d %d" % (type, pointIdx, value, duration))
		...
		if not self.AFFECT_DATA_DICT.has_key(affect) and (ENABLE_GROWTH_PET_SYSTEM and not self.AFFECT_PET_DATA_DICT.has_key(affect)):
			return

		# if ENABLE_GROWTH_PET_SYSTEM:
			# if not self.AFFECT_PET_DATA_DICT.has_key(affect) and affect >= 5400 and affect <= 5419:
				# return
		...
		if ENABLE_GROWTH_PET_SYSTEM and affect >= 5400 and affect <= 5420:
		...
		if trashValue == 1:
			...
			if affect != chr.NEW_AFFECT_AUTO_SP_RECOVERY and affect != chr.NEW_AFFECT_AUTO_HP_RECOVERY and ENABLE_GROWTH_PET_SYSTEM and not self.AFFECT_PET_DATA_DICT.has_key(affect):
			...
			try:
				...
				elif ENABLE_MONSTER_BACK and affect == chr.NEW_AFFECT_ATT_SPEED_SLOW:
					image.SetClock(False)
					image.UpdateDescription()
	...
	def __ArrangeImageList(self):
		if ENABLE_ARRAGNE_AFFECTS:
			width = 15 * self.IMAGE_STEP
			if self.lovePointImage:
			...
			self.SetSize(width, yPos + self.IMAGE_STEP)
		else:
