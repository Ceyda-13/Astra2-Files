...
const granny_int32x* CGrannyModelInstance::__GetMeshBoneIndices(unsigned int iMeshBinding) const // @@correction020
{
...
{
	assert("Not currently used - CGrannyModelInstance::ReloadTexture()"); // @@correction026
/*
	assert(m_pModel != NULL);
