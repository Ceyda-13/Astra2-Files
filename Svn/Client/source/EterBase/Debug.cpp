...
void _Trace(const char * c_szMsg)
{
#ifdef _DEBUG
...
void _Tracen(const char* c_szMsg)
{
#ifdef _DEBUG
	char szBuf[DEBUG_STRING_MAX_LEN+1];
...
void _Tracenf(const char* c_szFormat, ...)
{
	va_list args;
	va_start(args, c_szFormat);
...
void _Tracef(const char* c_szFormat, ...)
{
	char szBuf[DEBUG_STRING_MAX_LEN+1];
...
void _TraceError(const char* c_szFormat, ...)
{
#ifndef _DISTRIBUTE
...
void _TraceErrorWithoutEnter(const char* c_szFormat, ...)
{
#ifndef _DISTRIBUTE
