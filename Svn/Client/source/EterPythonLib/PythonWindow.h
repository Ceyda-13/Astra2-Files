...
namespace UI
{
	...
	class CRenderTarget : public CWindow, public CGraphicBase
	{
		...
		protected:
			...
			LPDIRECT3DTEXTURE8 m_RenderTexture;
			LPDIRECT3DSURFACE8 m_RenderTargetSurface, m_DepthSurface, m_PreviousRenderTarget, m_PreviousDepthBuffer;

			CInstanceBase* m_InstanceModel;
			std::map<DWORD, CInstanceBase*> m_InstanceModels;
