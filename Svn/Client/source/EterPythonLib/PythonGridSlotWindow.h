...
namespace UI
{
	...
	class CFishEventGridSlotWindow : public CGridSlotWindow
	{
		public:
			static DWORD Type();
			CFishEventGridSlotWindow(PyObject * ppyObject);
			virtual ~CFishEventGridSlotWindow();
			void Destroy();

			void SetPickedAreaRender(bool bFlag) { bIsPickedAreaRender = bFlag; }
			bool GetPickedAreaRender() { return bIsPickedAreaRender; }
