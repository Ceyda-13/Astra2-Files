...
class CInstanceBase
{
	...
	public:
		...
		enum
		{
			...
			NEW_AFFECT_ALIGN_BONUS1,
			NEW_AFFECT_ALIGN_BONUS2,
			NEW_AFFECT_ALIGN_BONUS3,
#endif
...
, BYTE bNewIsGuildName
	...
	protected:
		...
		void __EnableSkipCollision(bool bIsBin = false);
	...
	public:
		BOOL					IsNewPet();
		void 					UpdatePetScale(DWORD m_dwLevel);
