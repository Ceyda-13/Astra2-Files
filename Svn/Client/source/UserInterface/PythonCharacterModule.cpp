...
#ifdef ENABLE_GROWTH_PET_SYSTEM
PyObject* chrBraveRequestPetName(PyObject* poSelf, PyObject* poArgs)
{
	const char* petname;
...
PyObject* chrSetScale(PyObject* poSelf, PyObject* poArgs)
{
	...
	pInstance->GetGraphicThingInstancePtr()->SetScale(fX, fY, fZ, true);
	return Py_BuildNone();
}
...
void initchr()
{
...
#endif
#ifdef ENABLE_GROWTH_PET_SYSTEM
		{ "RequestPetName",					chrBraveRequestPetName,				METH_VARARGS },
#endif
...
#endif
#ifdef ENABLE_QUIVER_SYSTEM
	PyModule_AddIntConstant(poModule, "MOTION_MODE_BOW_SPECIAL", 			CRaceMotionData::MODE_BOW_SPECIAL);
	PyModule_AddIntConstant(poModule, "MOTION_MODE_HORSE_BOW_SPECIAL",		CRaceMotionData::MODE_HORSE_BOW_SPECIAL);
#endif
	...
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_SOUL", CInstanceBase::NEW_AFFECT_SOUL);
#endif
#ifdef ENABLE_12ZI
	PyModule_AddIntConstant(poModule, "AFFECT_ELECTRIC_SHOCK", CInstanceBase::AFFECT_ELECTRIC_SHOCK);
	PyModule_AddIntConstant(poModule, "AFFECT_CONFUSION", CInstanceBase::AFFECT_CONFUSION);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_ATT_GRADE_DOWN", CInstanceBase::NEW_AFFECT_ATT_GRADE_DOWN);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_DEF_GRADE_DOWN", CInstanceBase::NEW_AFFECT_DEF_GRADE_DOWN);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_CRITICAL_PCT_DOWN", CInstanceBase::NEW_AFFECT_CRITICAL_PCT_DOWN);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_CZ_UNLIMIT_ENTER", CInstanceBase::NEW_AFFECT_CZ_UNLIMIT_ENTER);
#endif
#ifdef ENABLE_ELEMENT_ADD
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_MOUNT_FALL",				CInstanceBase::NEW_AFFECT_MOUNT_FALL);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_NO_RECOVERY",				CInstanceBase::NEW_AFFECT_NO_RECOVERY);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_REDUCE_CAST_SPEED",		CInstanceBase::NEW_AFFECT_REDUCE_CAST_SPEED);
#endif
	...
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_ALIGN_BONUS1", CInstanceBase::NEW_AFFECT_ALIGN_BONUS1);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_ALIGN_BONUS2", CInstanceBase::NEW_AFFECT_ALIGN_BONUS2);
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_ALIGN_BONUS3", CInstanceBase::NEW_AFFECT_ALIGN_BONUS3);
#endif
#ifdef ENABLE_GUILD_DRAGONLAIR_SYSTEM
	PyModule_AddIntConstant(poModule, "NEW_AFFECT_STATUE", CInstanceBase::NEW_AFFECT_STATUE);
#endif
