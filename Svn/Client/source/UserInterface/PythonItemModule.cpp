...
PyObject* itemGetApplyPoint(PyObject* poSelf, PyObject* poArgs)
{
	...
	case CItemData::APPLY_RESIST_MOUNT_FALL:
		...
		break;
	case CItemData::APPLY_ENCHANT_AVATAR:
		iRet = POINT_ENCHANT_AVATAR;
		break;
#endif
	...
	case CItemData::APPLY_ATTBONUS_STONE:
		iRet = POINT_ATTBONUS_STONE;
		break;
	case CItemData::APPLY_ATTBONUS_BOSS:
		iRet = POINT_ATTBONUS_BOSS;
		break;
#endif
	default:
		iRet = 0;
...
void initItem()
{
	...
	PyModule_AddIntConstant(poModule, "EQUIPMENT_SHIELD",			c_Equipment_Shield); // @@correction025
	...
	PyModule_AddIntConstant(poModule, "COSTUME_TYPE_EFFECT", 		CItemData::COSTUME_EFFECT);
	PyModule_AddIntConstant(poModule, "COSTUME_SLOT_EFFECT_BODY", 	c_Costume_Slot_Effect1);
	PyModule_AddIntConstant(poModule, "COSTUME_SLOT_EFFECT_WEAPON",	c_Costume_Slot_Effect2);
#endif
	...
	PyModule_AddIntConstant(poModule, "WEAPON_MOUNT_SPEAR",			CItemData::WEAPON_MOUNT_SPEAR); // @@correction025
#ifdef ENABLE_WOLFMAN_CHARACTER
	...
	PyModule_AddIntConstant(poModule, "MATERIAL_DS_REFINE_MASTER",	CItemData::MATERIAL_DS_REFINE_MASTER);
#endif
	...
	PyModule_AddIntConstant(poModule, "ITEM_ANTIFLAG_SAFEBOX",		CItemData::ITEM_ANTIFLAG_SAFEBOX); // @@correction025
	...
	PyModule_AddIntConstant(poModule, "ANTIFLAG_SAFEBOX",			CItemData::ITEM_ANTIFLAG_SAFEBOX); // @@correction025
	...
	PyModule_AddIntConstant(poModule, "APPLY_ENCHANT_AVATAR", CItemData::APPLY_ENCHANT_AVATAR);
#endif
#ifdef ENABLE_PENDANT
