...
enum
{
...
#ifndef ENABLE_PLAYER_PER_ACCOUNT5 // @@correction038
	...
	SHOP_PAGE_COUNT = 2,
	SHOP_HOST_ITEM_MAX_NUM = SHOP_PAGE_SIZE * SHOP_PAGE_COUNT,
#else
	...
	WEAR_MAX_NUM = CItemData::WEAR_MAX_NUM, // @@correction004
...
enum EChatType
{
	...
	CHAT_TYPE_MONARCH_NOTICE, // @@correction025
#ifdef ENABLE_12ZI
...
#ifdef ENABLE_ACCE_SYSTEM // @correction191
...
typedef struct SOfflinePrivateShopItemUpdate
{
	uint32_t dwVid;
	TShopItemData item;
} TOfflinePrivateShopItemUpdate;

typedef struct SOfflinePrivateShopItemSearch
{
	uint32_t dwVid;
	char szSellerName[CHARACTER_NAME_MAX_LEN + 1];
	TShopItemData item;
} TOfflinePrivateShopItemSearch;

typedef struct SOfflinePrivateShopLog
{
	uint64_t dwPrice;
	uint32_t dwVnum;
	uint32_t dwDate;
} TOfflinePrivateShopLog;
#endif
