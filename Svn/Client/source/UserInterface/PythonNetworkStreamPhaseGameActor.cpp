...
bool CPythonNetworkStream::RecvCharacterAppendPacket()
{
	...
	kNetActorData.m_bNewIsGuildName = 0;
#endif
...
#endif
#ifdef ENABLE_GUILD_GENERAL_AND_LEADER
		kNetActorData.m_bNewIsGuildName = chrInfoPacket.bNewIsGuildName;
#endif
#ifdef ENABLE_MULTI_LANGUAGE
...
{
	TraceError("TPacketGCCharacterAdd2 is packet that doesn't write."); // @@correction026
...
#endif
#ifdef ENABLE_QUIVER_SYSTEM
	kNetActorData.m_dwArrowType=chrAddPacket.awPart[CHR_EQUIPPART_ARROW_TYPE];
#endif
#ifdef ENABLE_COSTUME_EFFECT
	kNetActorData.m_dwBodyEffect=chrAddPacket.awPart[CHR_EQUIPPART_BODY_EFFECT];
	kNetActorData.m_dwWeaponEffectRight=chrAddPacket.awPart[CHR_EQUIPPART_WEAPON_RIGHT_EFFECT];
	kNetActorData.m_dwWeaponEffectLeft=chrAddPacket.awPart[CHR_EQUIPPART_WEAPON_LEFT_EFFECT];
#endif
	__RecvCharacterAppendPacket(&kNetActorData);
...
#endif
#ifdef ENABLE_GUILD_GENERAL_AND_LEADER
	kNetUpdateActorData.m_bNewIsGuildName = chrUpdatePacket.bNewIsGuildName;
#endif
