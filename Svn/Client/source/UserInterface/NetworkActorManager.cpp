...
void SNetworkActorData::__copy__(const SNetworkActorData& src)
{
	...
	m_dwArrowType = src.m_dwArrowType;
#endif
	...
	m_bElement = src.m_bElement;
#endif
#ifdef ENABLE_GUILD_GENERAL_AND_LEADER
	m_bNewIsGuildName = src.m_bNewIsGuildName;
#endif
#ifdef ENABLE_MULTI_LANGUAGE
	m_stLanguage = src.m_stLanguage;
#endif
...
{
	Lognf(0, XOR("CNetworkActorManager::__AppendCharacterManagerActor(%d, %s)"), rkNetActorData.m_dwVID, rkNetActorData.m_stName.c_str());
...
#endif
#ifdef ENABLE_QUIVER_SYSTEM
	kCreateData.m_dwArrowType=rkNetActorData.m_dwArrowType;
#endif
#ifdef ENABLE_COSTUME_EFFECT
...
#endif
#ifdef ENABLE_GUILD_GENERAL_AND_LEADER
	kCreateData.m_bNewIsGuildName = rkNetActorData.m_bNewIsGuildName;
#endif
#ifdef ENABLE_MULTI_LANGUAGE
	kCreateData.m_stLanguage = rkNetActorData.m_stLanguage;
#endif
/*#ifdef ENABLE_ELEMENT_ADD
	kCreateData.m_bElement = rkNetActorData.m_bElement;
#endif*/
...
#ifdef ENABLE_GUILD_GENERAL_AND_LEADER
, c_rkNetUpdateActorData.m_bNewIsGuildName
#endif
);
...
#endif
#ifdef ENABLE_ELEMENT_ADD
		pkInstFind->SetElement(c_rkNetUpdateActorData.m_bElement);
#endif
...
#endif
#ifdef ENABLE_QUIVER_SYSTEM
	rkNetActorData.m_dwArrowType=c_rkNetUpdateActorData.m_dwArrowType;
#endif
#ifdef ENABLE_COSTUME_EFFECT
...
#endif
#ifdef ENABLE_ELEMENT_ADD
	rkNetActorData.m_bElement = c_rkNetUpdateActorData.m_bElement;
#endif
#ifdef ENABLE_GUILD_GENERAL_AND_LEADER
	rkNetActorData.m_bNewIsGuildName = c_rkNetUpdateActorData.m_bNewIsGuildName;
#endif
}
