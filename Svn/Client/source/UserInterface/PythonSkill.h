...
class CPythonSkill : public CSingleton<CPythonSkill>
{
	public:
		...
		enum
		{
			...
			SKILL_NEED_WEAPON_ARROW 			= (1 << CItemData::WEAPON_ARROW || 1 << CItemData::WEAPON_QUIVER),
#else
			SKILL_NEED_WEAPON_ARROW				= (1 << CItemData::WEAPON_ARROW),
#endif
			SKILL_NEED_WEAPON_MOUNT_SPEAR		= (1 << CItemData::WEAPON_MOUNT_SPEAR), // @@correction025
