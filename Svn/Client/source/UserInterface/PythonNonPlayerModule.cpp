...
PyObject* nonplayerGetAttElementFlagByVID(PyObject* poSelf, PyObject* poArgs)
{
	...
	return Py_BuildValue("i", CPythonNonPlayer::Instance().GetElement(iVID));
}
#endif
...
#ifdef ENABLE_ELEMENT_ADD
	PyModule_AddIntConstant(poModule, "RACE_FLAG_ATT_ELEC", CPythonNonPlayer::ELEMENT_ELEC);
	PyModule_AddIntConstant(poModule, "RACE_FLAG_ATT_FIRE", CPythonNonPlayer::ELEMENT_FIRE);
	PyModule_AddIntConstant(poModule, "RACE_FLAG_ATT_ICE", CPythonNonPlayer::ELEMENT_ICE);
	PyModule_AddIntConstant(poModule, "RACE_FLAG_ATT_WIND", CPythonNonPlayer::ELEMENT_WIND);
	PyModule_AddIntConstant(poModule, "RACE_FLAG_ATT_EARTH", CPythonNonPlayer::ELEMENT_EARTH);
	PyModule_AddIntConstant(poModule, "RACE_FLAG_ATT_DARK", CPythonNonPlayer::ELEMENT_DARK);
#endif
}