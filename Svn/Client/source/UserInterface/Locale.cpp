...
int LocaleService_GetSkillPower(unsigned level)
{
	...
	static const unsigned SKILL_POWER_NUM = 60;
#else
...
#ifdef ENABLE_SKILLS_LEVEL_OVER_P
				160, 170, 180, 190, 200, 210, 220, 230, 240, 250, // Sage
				260,
#else
				150,
#endif
	...
	static unsigned INTERNATIONAL_SKILL_POWERS[SKILL_POWER_NUM]=
	{
		...
		85, 88, 91, 94, 98,
		102,106,110,115,130,// perfect_master
#ifdef ENABLE_SKILLS_LEVEL_OVER_P
		140, 150, 160, 170, 180, 190, 200, 210, 220, 230, // Sage
		240,
#else
		130,
#endif
