...
class CPythonPlayer : public CSingleton<CPythonPlayer>, public IAbstractPlayer
{
	...
	public:
		void	SetItemChangeLook(TItemPos itemPos, DWORD dwVnum);
		DWORD	GetItemChangeLook(TItemPos itemPos);
#endif
	...
	public:
		uint64_t	GetGold() const { return dwGold; }
		void		SetGold(uint64_t gold) { dwGold = gold; }
