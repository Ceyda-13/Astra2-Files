...
void initapp()
{
...
#ifdef ENABLE_PLAYER_PER_ACCOUNT5 // @@correction038
...
#ifdef ENABLE_SEQUENCE_SYSTEM // @@correction021
	PyModule_AddIntConstant(poModule, "ENABLE_SEQUENCE_SYSTEM",	1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SEQUENCE_SYSTEM",	0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_SHOP_TAB", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SHOP_TAB", 0);
#endif
...
#ifdef ENABLE_DISCORD_RPC
	PyModule_AddIntConstant(poModule, "ENABLE_DISCORD_RPC", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_DISCORD_RPC", 0);
#endif
...
#define ENABLE_PACK_PROTECT
	...
	PyModule_AddIntConstant(poModule, "agh", 1);
#else
	PyModule_AddIntConstant(poModule, "agh", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_OFFLINE_PRIVATE_SHOP",	1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_OFFLINE_PRIVATE_SHOP",	0);
#endif
...
#else
	PyModule_AddIntConstant(poModule, "ENABLE_COSTUME_MOUNT", 0);
#endif

#ifdef ENABLE_COSTUME_PET
	PyModule_AddIntConstant(poModule, "ENABLE_COSTUME_PET", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_COSTUME_PET", 0);
#endif

#ifdef ENABLE_NEW_BONUSES
	PyModule_AddIntConstant(poModule, "ENABLE_NEW_BONUSES", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_NEW_BONUSES", 0);
#endif

#ifdef ENABLE_ALIGN_RENEWAL
	PyModule_AddIntConstant(poModule, "ENABLE_ALIGN_RENEWAL", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_ALIGN_RENEWAL", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_TEMPLE_OCHAO", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_TEMPLE_OCHAO", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_BOSS_TRACKING", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_BOSS_TRACKING", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_MINI_GAME_FINDM", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_MINI_GAME_FINDM", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "ENABLE_RITUEL_STONE", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_RITUEL_STONE", 0);
#endif

#ifdef ENABLE_GUILD_GENERAL_AND_LEADER
	PyModule_AddIntConstant(poModule, "ENABLE_GUILD_GENERAL_AND_LEADER", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_GUILD_GENERAL_AND_LEADER", 0);
#endif
...
#ifdef ENABLE_DS_REFINE_MASTER
	PyModule_AddIntConstant(poModule, "ENABLE_DS_REFINE_MASTER", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_DS_REFINE_MASTER", 0);
#endif

#ifdef ENABLE_SHOW_MAP_BOSS_AND_STONE
	PyModule_AddIntConstant(poModule, "ENABLE_SHOW_MAP_BOSS_AND_STONE", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SHOW_MAP_BOSS_AND_STONE", 0);
#endif

#ifdef ENABLE_FAST_USE_GIFTBOX
	PyModule_AddIntConstant(poModule, "ENABLE_FAST_USE_GIFTBOX", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_FAST_USE_GIFTBOX", 0);
#endif

#ifdef ENABLE_YANG_INFO
	PyModule_AddIntConstant(poModule, "ENABLE_YANG_INFO", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_YANG_INFO", 0);
#endif

#ifdef ENABLE_AUTO_PICKUP
	PyModule_AddIntConstant(poModule, "ENABLE_AUTO_PICKUP", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_AUTO_PICKUP", 0);
#endif
	...
	PyModule_AddIntConstant(poModule, "WJ_SECURITY_SYSTEM", 1);
#else
	PyModule_AddIntConstant(poModule, "WJ_SECURITY_SYSTEM", 0);
#endif

#ifdef ENABLE_SKILLS_LEVEL_OVER_P
	PyModule_AddIntConstant(poModule, "ENABLE_SKILLS_LEVEL_OVER_P", 1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_SKILLS_LEVEL_OVER_P", 0);
#endif
