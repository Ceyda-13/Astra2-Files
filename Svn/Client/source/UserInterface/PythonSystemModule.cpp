...
PyObject * systemSetShowMobLevel(PyObject * poSelf, PyObject * poArgs)
{
	...
	CPythonSystem::Instance().SetShowMobLevel(bIsOpen);
...
PyObject * systemSetShowMobAIFlag(PyObject * poSelf, PyObject * poArgs)
{
	...
	CPythonSystem::Instance().SetShowMobAIFlag(bIsOpen);
...
PyObject* systemGetFogMode(PyObject* poSelf, PyObject* poArgs)
{
	return Py_BuildValue("i", CPythonSystem::Instance().GetFogMode());
}
#endif
...
PyObject * systemSetSnowModeOption(PyObject * poSelf, PyObject * poArgs)
{
	...
	CPythonSystem::Instance().SetSnowModeOption(bFlag);
	return Py_BuildNone();
}
...
PyObject * systemSetSnowTextureModeOption(PyObject * poSelf, PyObject * poArgs)
{
	...
	CPythonSystem::Instance().SetSnowTextureModeOption(bFlag);
	return Py_BuildNone();
}
...
PyObject * systemSetNightModeOption(PyObject * poSelf, PyObject * poArgs)
{
	...
	CPythonSystem::Instance().SetNightModeOption(bFlag);
	return Py_BuildNone();
}
...
PyObject* systemSetYangInfo(PyObject* poSelf, PyObject* poArgs)
{
	int iFlag;
	if (!PyTuple_GetInteger(poArgs, 0, &iFlag))
		return Py_BuildException();

	CPythonSystem::Instance().SetYangInfo(iFlag);

	return Py_BuildNone();
}

PyObject* systemGetYangInfo(PyObject* poSelf, PyObject* poArgs)
{
	return Py_BuildValue("i", CPythonSystem::Instance().GetYangInfo());
}
#endif

#ifdef ENABLE_AUTO_PICKUP
PyObject* systemSetAutoPick(PyObject* poSelf, PyObject* poArgs)
{
	int iFlag;
	if (!PyTuple_GetInteger(poArgs, 0, &iFlag))
		return Py_BuildException();

	CPythonSystem::Instance().SetAutoPick(iFlag);

	return Py_BuildNone();
}

PyObject* systemGetAutoPick(PyObject* poSelf, PyObject* poArgs)
{
	return Py_BuildValue("i", CPythonSystem::Instance().GetAutoPick());
}
#endif
...
void initsystemSetting()
{
	static PyMethodDef s_methods[] =
	{
		...
		{ "GetFogMode",					systemGetFogMode,				METH_VARARGS },
#endif
#ifdef ENABLE_ENVIRONMENT_EFFECT_OPTION
...
#endif
#ifdef ENABLE_YANG_INFO
		{ "SetYangInfo",				systemSetYangInfo,				METH_VARARGS },
		{ "GetYangInfo",				systemGetYangInfo,				METH_VARARGS },
#endif
#ifdef ENABLE_AUTO_PICKUP
		{ "SetAutoPick",				systemSetAutoPick,				METH_VARARGS },
		{ "GetAutoPick",				systemGetAutoPick,				METH_VARARGS },
#endif
		{ NULL,							NULL,							NULL }
	};
