...
PyObject * safeboxGetItemChangeLook(PyObject * poSelf, PyObject * poArgs)
{
	int iPos;
	if (!PyTuple_GetInteger(poArgs, 0, &iPos))
		return Py_BadArgument();
	...
	return Py_BuildValue("i", pInstance->changelook);
}

PyObject * safeboxGetMallItemChangeLook(PyObject * poSelf, PyObject * poArgs)
{
	int iPos;
	if (!PyTuple_GetInteger(poArgs, 0, &iPos))
		return Py_BadArgument();
...
#ifdef ENABLE_CHANGE_LOOK_SYSTEM
		{ "GetItemChangeLook",			safeboxGetItemChangeLook, 			METH_VARARGS },
		{ "GetMallItemChangeLook",		safeboxGetMallItemChangeLook, 		METH_VARARGS },
#endif
		{ NULL,							NULL,									NULL },
	};
