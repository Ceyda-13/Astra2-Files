...
class IAbstractPlayer : public TAbstractSingleton<IAbstractPlayer>
{
	public:
		...
		virtual void	SetItemCount(TItemPos itemPos, WORD wCount) = 0;
		...
		virtual void	SetItemChangeLook(TItemPos itemPos, DWORD dwVnum) = 0;
		virtual DWORD	GetItemChangeLook(TItemPos itemPos) = 0;
#endif
};
