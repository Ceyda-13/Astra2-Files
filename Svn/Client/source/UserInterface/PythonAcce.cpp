...
void CPythonAcce::AddMaterial(uint64_t dwRefPrice, BYTE bPos, TItemPos tPos)
{
...
void CPythonAcce::RemoveMaterial(uint64_t dwRefPrice, BYTE bPos)
{
	if (bPos >= ACCE_WINDOW_MAX_MATERIALS)
		return;
...
{
	return Py_BuildValue("K", CPythonAcce::Instance().GetPrice());
}
