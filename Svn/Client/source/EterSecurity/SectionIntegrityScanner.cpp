...
void CAnticheatManager::SetupSectionMonitorContainer()
{
	...
	if (hProcessBase)
	{
		...
		{
			m_vMonitoredModules.emplace_back(hProcessBase);
		}
	}
	...
	if (hKernel32)
	{
		...
		{
			m_vMonitoredModules.emplace_back(hKernel32);
		}
	}
	...
	if (hKernelBase)
	{
		...
		{
			m_vMonitoredModules.emplace_back(hKernelBase);
		}
	}
	...
	if (hNtdll)
	{
		...
		{
			m_vMonitoredModules.emplace_back(hNtdll);
		}
	}
	...
	if (hUser32)
	{
		...
		{
			m_vMonitoredModules.emplace_back(hUser32);
		}
	}
	...
	if (hWin32u)
	{
		...
		{
			m_vMonitoredModules.emplace_back(hWin32u);
		}
	}
	...
	// {
		...
		// else
		// {
			// m_vMonitoredModules.emplace_back(hPython27);
		// }
	// }
}
