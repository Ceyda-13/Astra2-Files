...
class CActorInstance : public IActorInstance, public IFlyTargetableObject
{
	...
	public:
		...
		void SetAcce(CItemData * pItemData, float fSpecular = 0.0f);
#endif
...
#ifdef ENABLE_12ZI
	public:
		void AttachShelter(BYTE bType);
		bool IsHaveSpecial() { return bIsHaveSpecial; }
		void AttachSpecial();

	protected:
		bool bIsHaveSpecial;
		float fSpecialPos[4][2];
		D3DXMATRIX SpecialMatrix[4];
		bool bIsUsingShelter;
#endif
