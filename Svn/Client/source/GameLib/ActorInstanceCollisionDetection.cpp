...
{
	m_canSkipCollision = 0x564568778;
}

void CActorInstance::EnableSkipCollision()
{
	//TraceError("EnableSkipCollision: Enabled");
	m_canSkipCollision = 0x5467406;
}
...
{
	return m_canSkipCollision == 0x5467406;
}
...
*/
	...
	if (rVictim.IsEnemy()/* || rVictim.IsNPC()*/)
		return FALSE;
...
// @@correction023 BEGIN
	...
	if (rVictim.GetRace()>=30000 && rVictim.GetRace()<=30007)
		return FALSE;
#endif
