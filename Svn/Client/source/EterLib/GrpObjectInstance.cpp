...
void CGraphicObjectInstance::Transform()
{
	...
	m_TransformMatrix._41 += m_v3ScalePosition.x + m_v3Position.x;
	m_TransformMatrix._42 += m_v3ScalePosition.y + m_v3Position.y;
	m_TransformMatrix._43 += m_v3ScalePosition.z + m_v3Position.z;
#endif
}
