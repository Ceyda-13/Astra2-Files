...
const uint32_t c_arSwitchingItems[3] =
{
	39028,
	71084,
	76014,
...
// @correction130 BEGIN
	...
	INVENTORY_ONE_MAX_NUM 	= INVENTORY_PAGE_SIZE * INVENTORY_PAGE_COUNT,
	INVENTORY_MAX_NUM		= INVENTORY_ONE_MAX_NUM * INVENTORY_MAX,
// @correction130 END
	...
	SHOP_PRICELIST_MAX_NUM	= SHOP_HOST_ITEM_MAX_NUM,
#else
	...
	MAP_ALLOW_LIMIT = 32, // @correction100
...
typedef struct SItemPos
{
	...
	{
		return (DRAGON_SOUL_EQUIP_SLOT_START <= cell) && (DRAGON_SOUL_EQUIP_SLOT_END > cell) && (INVENTORY == window_type || EQUIPMENT == window_type);
	}

	bool IsBeltInventoryPosition() const
	{
		return (BELT_INVENTORY_SLOT_START <= cell) && (BELT_INVENTORY_SLOT_END > cell) && window_type == BELT_INVENTORY;
	}
...
#ifdef __EXTEND_INVEN__
	bool IsInventoryPosition(uint8_t bType) const
	{
		return INVENTORY == window_type && cell >= INVENTORY_ONE_MAX_NUM * bType && cell < INVENTORY_ONE_MAX_NUM * (bType + 1);
	}
#endif
