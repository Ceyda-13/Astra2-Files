...
int32_t GetKillValue(int32_t level)
{
	...
	// @correction005
	iMinLevelFor1Point = 30;
	iMaxLevelFor1Point = 39;
	iMinLevelFor2Point = 40;
	iMaxLevelFor2Point = 49;
	iMinLevelFor3Point = 50;
	iMaxLevelFor3Point = gPlayerMaxLevel; // @correction070
