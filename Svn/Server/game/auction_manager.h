...
#include "../libsrc/libsql/AsyncSQL.h"
...
private:
	typedef std::unordered_map <uint32_t, TAuctionItemInfo*> TItemInfoMap;
	TItemInfoMap item_map;

	typedef std::map <uint32_t, TAuctionItemInfo*> TItemMap;
	typedef std::unordered_map <uint32_t, TItemMap*> TPCMap;
...
{
private:
	typedef std::unordered_map <uint32_t, TSaleItemInfo*> TItemInfoMap;
	TItemInfoMap item_map;
...
private:
	...
	typedef std::unordered_map <uint32_t, TItemMap*> TMyBidBoard;
	TMyBidBoard pc_map;
...
{
private :
	typedef std::unordered_map<uint32_t, LPITEM> TItemMap;
