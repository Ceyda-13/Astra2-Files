...
ACMD(do_click_safebox); // @correction003
...
struct command_info cmd_info[] =
{
	...
	{ "console",	do_console,		0,			POS_DEAD,	GM_HIGH_WIZARD	},
	...
	{ "setskill",	do_setskill,		0,			POS_DEAD,	GM_HIGH_WIZARD	},
	...
	// @correction032 (removed configs)

	{ "detaillog",	do_detaillog,		0,			POS_DEAD,	GM_HIGH_WIZARD	},
	{ "monsterlog",	do_monsterlog,		0,			POS_DEAD,	GM_HIGH_WIZARD	},
	...
	{ "affect_remove",	do_affect_remove,	0,			POS_DEAD,	GM_HIGH_WIZARD	},
	...
	{ "pcbang_update", 	do_pcbang_update,	0,			POS_DEAD,	GM_HIGH_WIZARD	},
	{ "pcbang_check", 	do_pcbang_check,	0,			POS_DEAD,	GM_HIGH_WIZARD	},
	...
	{ "show_quiz",			do_oxevent_show_quiz,	0,	POS_DEAD,	GM_HIGH_WIZARD	},
	{ "log_oxevent",		do_oxevent_log,			0,	POS_DEAD,	GM_HIGH_WIZARD	},
	{ "get_oxevent_att",	do_oxevent_get_attender,0,	POS_DEAD,	GM_HIGH_WIZARD	},
	...
	{ "rmcandidacy",		do_rmcandidacy,			0, 	POS_DEAD,	GM_HIGH_WIZARD},
	{ "setmonarch",			do_setmonarch,			0, 	POS_DEAD,	GM_HIGH_WIZARD},
	{ "rmmonarch",			do_rmmonarch,			0, 	POS_DEAD, 	GM_HIGH_WIZARD},
	{ "hair",				do_hair,				0,	POS_DEAD,	GM_PLAYER	},
	{ "inventory",			do_inventory,			0,	POS_DEAD,	GM_HIGH_WIZARD	},
	{ "cube",				do_cube,				0,	POS_DEAD,	GM_PLAYER	},
	{ "siege",				do_siege,				0,	POS_DEAD,	GM_HIGH_WIZARD	},
	...
	{ "weeklyevent",		do_weeklyevent,			0,	POS_DEAD,	GM_HIGH_WIZARD	},
	...
	{ "item_id_list",	do_get_item_id_list,	0,	POS_DEAD,	GM_HIGH_WIZARD	},
	{ "set_socket",		do_set_socket,			0,	POS_DEAD,	GM_HIGH_WIZARD	},
#ifdef __AUCTION__
	...
	{ "full_set",	do_full_set, 0, POS_DEAD,		GM_HIGH_WIZARD},
	{ "item_full_set",	do_item_full_set, 0, POS_DEAD,		GM_HIGH_WIZARD},
	{ "attr_full_set",	do_attr_full_set, 0, POS_DEAD,		GM_HIGH_WIZARD},
	{ "all_skill_master",	do_all_skill_master,	0,	POS_DEAD,	GM_HIGH_WIZARD},
	{ "use_item",		do_use_item,	0, POS_DEAD,		GM_HIGH_WIZARD},

	{ "dragon_soul",				do_dragon_soul,				0,	POS_DEAD,	GM_PLAYER	},
	{ "ds_list",				do_ds_list,				0,	POS_DEAD,	GM_PLAYER	},
	{ "do_clear_affect", do_clear_affect, 	0, POS_DEAD,		GM_HIGH_WIZARD},
#ifdef ENABLE_NEWSTUFF //@correction232
	{ "add_rare_attr",		do_add_rare_attr,			0,			POS_DEAD,	GM_IMPLEMENTOR	},
	{ "change_rare_attr",	do_change_rare_attr,		0,			POS_DEAD,	GM_IMPLEMENTOR	},
	{ "click_safebox",		do_click_safebox,			0,			POS_DEAD,	GM_PLAYER	}, // @correction003
...
#endif
#ifdef ENABLE_FAST_NPC // @correction194
	{ "npc_open", 	do_npc_open,	0,			POS_DEAD,	GM_PLAYER		},
#endif
#ifdef __OFFLINE_PRIVATE_SHOP__
	{ "click_offline_private_shop",		do_click_offline_private_shop,		0,	POS_DEAD,	GM_PLAYER	},
	{ "price_check", do_price_check, 0, POS_DEAD,	GM_PLAYER	},
#endif
#ifdef __MOVE_CHANNEL__
	...
	{ "support_system_w", do_support_system_w, 0, POS_DEAD, GM_PLAYER },
#endif
#ifdef __GROWTH_PET__
	...
	{ "growth_change_namee",	do_PetChangeName,	0,	POS_DEAD,	GM_PLAYER	},
	{ "determine",	do_Determine,	0,	POS_DEAD,	GM_PLAYER	},
	{ "petattr",	do_PetAttr,	0,	POS_DEAD,	GM_PLAYER	},
	{ "petrevert",	do_PetRevert,	0,	POS_DEAD,	GM_PLAYER	},
#endif
#ifdef __BOSS_TRACKING_SYSTEM__
	{ "open_boss_tracking", do_open_boss_tracking, 0, POS_DEAD, GM_PLAYER },
	{ "close_boss_tracking", do_close_boss_tracking, 0, POS_DEAD, GM_PLAYER },
#endif
#ifdef __SORT_INVENTORY__
	{ "click_sort_inventory_items",	do_sort_inventory_items,	0,	POS_DEAD,	GM_PLAYER },
	{ "click_sort_safebox_items",	do_sort_safebox_items,	0,	POS_DEAD,	GM_PLAYER },
#endif
#ifdef __SPILT_ITEMS__
...
#endif
#ifdef __FAST_RUHBK__
	{ "fastruh",	do_fastruh,	0,	POS_DEAD,	GM_PLAYER },
	{ "fastbk",	do_fastbk,	0,	POS_DEAD,	GM_PLAYER },
#endif
#ifdef __AFAR_BIOLOG__
	{ "afarbio",	do_biyolog,	0,	POS_DEAD,	GM_PLAYER },
#endif
#ifdef __AUTO_PICKUP__
	{ "fasstt_pick", do_autopick, 0, POS_DEAD, GM_PLAYER	},
#endif
#ifdef __BLOCK_EXP__
	{ "blockk_exp", do_bolckexp, 0, POS_DEAD, GM_PLAYER	},
#endif
#ifdef WJ_SECURITY_SYSTEM
	{ "cp_a", do_input_security, 0, POS_DEAD,	GM_PLAYER	},
#endif
#ifdef __HARDWARE_INFOS__
	{ "hw_ban", do_hardware_ban, 0, POS_DEAD, GM_IMPLEMENTOR },
#endif
	{ "down", do_down, 0, POS_DEAD,	GM_IMPLEMENTOR	},
...
void interpret_command(LPCHARACTER ch, const char * argument, size_t len)
{
...
#ifdef ENABLE_BLOCK_CMD_SHORTCUT // @correction158
	...
	if (cmd_info[icmd].gm_level && (cmd_info[icmd].gm_level > ch->GetGMLevel() || cmd_info[icmd].gm_level == GM_DISABLE)) // @correction101
	{
		ch->ChatPacket(CHAT_TYPE_INFO, LC_TEXT("그런 명령어는 없습니다"));
		return;
	}
