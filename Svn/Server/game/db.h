...
class DBManager : public singleton<DBManager>
{
	public:
		...
		void			SendMoneyLog(uint8_t type, uint32_t vnum, uint64_t gold);

		void			LoginPrepare(uint8_t bBillType, uint32_t dwBillID, int32_t lRemainSecs, LPDESC d, uint32_t * pdwClientKey, int32_t * paiPremiumTimes = nullptr);
