...
static float MOB_GetNormalAttackDuration(TMobTable* mobTable)
{
	...
	snprintf(motlistPath, sizeof(motlistPath), "/usr/game/share/data/monster/%s/motlist.txt", folder);
#else
	...
	while (fgets(line, sizeof(line), fp))
	{
		...
		{
			char msaPath[1024 + 128];
#ifdef ENABLE_COMMON_FILES // @correction149
			snprintf(msaPath, sizeof(msaPath), "/usr/game/share/data/monster/%s/%s", folder, msaName);
#else
...
static const char* GetMotionFileName(TMobTable* mobTable, EPublicMotion motion)
{
	...
	const char * folder = mobTable->szFolder;
#ifdef ENABLE_COMMON_FILES // @correction149
	snprintf(buf, sizeof(buf), "/usr/game/share/data/monster/%s/motlist.txt", folder);
#else
...
#ifdef ENABLE_COMMON_FILES // @correction149
				str = "/usr/game/share/data/monster/";
#else
				str = "data/monster/";
#endif
				str += folder;
...
bool CMotionManager::Build()
{
	...
	{
#ifdef ENABLE_COMMON_FILES // @correction149
		"/usr/game/share/data/pc/warrior",
		"/usr/game/share/data/pc/assassin",
		"/usr/game/share/data/pc/sura",
		"/usr/game/share/data/pc/shaman",
		"/usr/game/share/data/pc2/warrior",
		"/usr/game/share/data/pc2/assassin",
		"/usr/game/share/data/pc2/sura",
		"/usr/game/share/data/pc2/shaman",
#ifdef ENABLE_WOLFMAN_CHARACTER // @correction190
		"/usr/game/share/data/pc3/wolfman",
#endif
#else
		"data/pc/warrior",
		"data/pc/assassin",
