...
CPasspod::CPasspod()
	: m_sock(INVALID_SOCKET), m_lpFDW(nullptr)
{
}
...
int32_t CPasspod::ConfirmPasspod( const char * account, const char * passpod )
{
	...
	int32_t ret = socket_write( m_sock, (const char *)szResult, strlen(szResult));
