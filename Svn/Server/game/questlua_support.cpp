...
namespace quest
{
	...
	int32_t support_summon(lua_State* L)
	{
		LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
		CSupport* supportSystem = ch->GetSupportSystem();
	...
	int32_t support_unsummon(lua_State* L)
	{
		LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
		CSupport* supportSystem = ch->GetSupportSystem();
	...
	// syntax: support.unsummon(mob_vnum)
	int32_t support_count_summoned(lua_State* L)
	{
		LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
		CSupport* supportSystem = ch->GetSupportSystem();
	...
	int32_t support_is_summon(lua_State* L)
	{
		LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
		CSupport* supportSystem = ch->GetSupportSystem();
	...
	int32_t support_spawn_effect(lua_State* L)
	{
		LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
		CSupport* supportSystem = ch->GetSupportSystem();
