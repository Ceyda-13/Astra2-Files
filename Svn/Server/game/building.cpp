...
bool CManager::LoadObjectProto(const TObjectProto * pProto, int32_t size)
{
	...
	for (int32_t i = 0; i < size; ++i)
	{
		...
		sys_log(0, "ObjectProto %u price %llu upgrade %u upg_limit %u life %d NPC %u",
...
void CManager::DeleteObject(uint32_t dwID)
{
