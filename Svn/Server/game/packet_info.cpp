...
CPacketInfoCG::CPacketInfoCG()
{
	...
	Set(HEADER_CG_LOGIN5_OPENID, sizeof(TPacketCGLogin5), "Login5", true);
	...
	Set(HEADER_CG_ITEM_DESTROY, sizeof(TPacketCGItemDestroy), "ItemDestroy", true); // @correction126
	...
	Set(HEADER_CG_ATTENDANCE_REQUEST_REWARD_LIST, sizeof(uint8_t), "AttendanceRequestRewardList", false);
...
CPacketInfoGG::CPacketInfoGG()
{
	...
	Set(HEADER_GG_RELOAD_COMMAND,		sizeof(TPacketGGReloadCommand),		"ReloadCommand",		false); // @correction235
#ifdef __OFFLINE_PRIVATE_SHOP__
	Set(HEADER_GG_OFFLINE_PRIVATE_SHOP_INFO,		sizeof(TPacketGGOfflinePrivateShopInfo),	"OfflinePrivateShop",	false);
	Set(HEADER_GG_OFFLINE_PRIVATE_SHOP_ITEM_DEL,		sizeof(TPacketGGOfflinePrivateShopItemDel),	"OfflinePrivateShop",	false);
	Set(HEADER_GG_OFFLINE_PRIVATE_SHOP_ITEM_ADD,		sizeof(TPacketGGOfflinePrivateShopItemAdd),	"OfflinePrivateShop",	false);
	Set(HEADER_GG_OFFLINE_PRIVATE_SHOP_RENAME,		sizeof(TPacketGGOfflinePrivateShopRename),	"OfflinePrivateShop",	false);
	Set(HEADER_GG_OFFLINE_PRIVATE_SHOP_ITEM_SEARCH,		sizeof(TPacketGGOfflinePrivateShopSearch),	"OfflinePrivateShop",	false);
	Set(HEADER_GG_OFFLINE_PRIVATE_SHOP_ITEM_BUY,		sizeof(TPacketGGOfflinePrivateShopBuy),	"OfflinePrivateShop",	false);
	Set(HEADER_GG_OFFLINE_PRIVATE_SHOP_UNLOCK_SLOTS,		sizeof(TPacketGGOfflinePrivateShopUnlockSlots),	"OfflinePrivateShop",	false);
#endif
