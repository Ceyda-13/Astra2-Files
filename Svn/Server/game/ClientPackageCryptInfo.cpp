...
#ifndef __FreeBSD__
#include "../libsrc/libthecore/xdirent.h"
#endif

CClientPackageCryptInfo::CClientPackageCryptInfo() : m_nCryptKeyPackageCnt(0), m_pSerializedCryptKeyStream(nullptr)
{
}
...
CClientPackageCryptInfo::~CClientPackageCryptInfo()
{
	...
	if( m_pSerializedCryptKeyStream )
	{
		...
		m_pSerializedCryptKeyStream = nullptr;
	}
}
