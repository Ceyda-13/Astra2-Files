...
#include <queue>
#include <utility>
#include "../libsrc/libsql/libsql.h"
#include "../libsrc/libthecore/poly.h"
...
struct TGuildDeclareInfo
{
	...
	{
		return ((dwGuildID[0] < r.dwGuildID[0]) || ((dwGuildID[0] == r.dwGuildID[0]) && (dwGuildID[1] < r.dwGuildID[1]))); // @correction111
	}
...
struct TGuildWaitStartInfo
{
	...
	{
		return ((GID[0] < r.GID[0]) || ((GID[0] == r.GID[0]) && (GID[1] < r.GID[1]))); // @correction111
	}
};
...
{
    return ((a.GID < b.GID) || ((a.GID == b.GID) && (a.dwSkillVnum < b.dwSkillVnum))); // @correction111
}
